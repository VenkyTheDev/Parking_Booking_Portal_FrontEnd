...
import { formatTime, getTimelineWidth, getStartPosition, getTotalBookingHours } from "../../../utils/historyUtils";
import { HOST } from "../../../utils/constants";

const BookingCard = ({ booking }) => {
  const statusColor = booking.status === "SUCCESS" ? "green" : booking.status === "CANCELLED" ? "red" : "orange";
  ...
  return (
    <Card
      sx={{
        ...
        "&:hover": { transform: "scale(1.05)", boxShadow: "0 10px 20px rgba(0, 0, 0, 0.15)" },
    ...
    >
      <CardContent sx={{ p: 3 }}>
        <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2, marginBottom: 2, flexDirection: "column" }}>
